...
\033[97m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒""")
print(f"\033[97m╔{'═' * 88}╗")
print(f"\033[97m║ \033[100m{' ' * 4}v.1.0{' ' * 77}\033[0m ║")
...
def udp_flood(ip, port, message, duration):
    ...
    while True:
        ...
        try:
            ...
            packet_count += 1
            print(f"\033[48;5;7m\033[38;5;0m {packet_count}\033[0m \033[38;5;6mSend messages to the server \033[38;5;5mm" +str(ip)+ "\033[33minfo running")
            print(f"\033[32m[][][][ \033[38mSend messages to the server \033[38;5;1m" +str(ip)+ "")
        except socket.error:
