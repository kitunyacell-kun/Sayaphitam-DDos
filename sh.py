...
\033[97m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒""")
print(f"\033[97m╔{'═' * 86}╗")
print(f"\033[97m║ \033[100m{' ' * 4}v.1.0{' ' * 75}\033[0m ║")
print(f"\033[97m║ \033[100m{' ' * 4}https://www.https//kunkaffa@gmail.com{' ' * 43}\033[0m ║")
print(f"\033[97m╚{'═' * 86}╝")
while attemps < 100:
...
def udp_flood(ip, port, message, duration):
    ...
    while True:
        ...
        try:
            ...
            packet_count += 1
            print(f"\033[48;5;7m\033[38;5;0mSend messages to the server" +str(ip)+ "\033[0m \033[33minfo running \033[32m"+{packet_count}+"")
