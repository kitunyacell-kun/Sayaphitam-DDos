...
\033[97m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒""")
print(f"\033[97m╔{'═' * 90}╗")
print(f"\033[97m║ \033[100m{' ' * 4}v.1.0{' ' * 79}\033[0m ║")
print(f"\033[97m║ \033[100m{' ' * 4}https://www.https//kunkaffa@gmail.com{' ' * 47}\033[0m ║")
print(f"\033[97m╚{'═' * 90}╝")
while attemps < 100:
...
def syn_flood(ip, port, duration):
    ...
    while True:
        try:
            ...
            sent += 1
            print(f"\033[100m\033[97m Syn flood \033[0m \033[32m{sent} \033[96m{ip}\033[0m 033[38;5;5mmSpoofing-attack")
            print(f"033[48;5;7m\033[48;5;7m\033[38;5;0m Syn flood \033[0m \033[33m{sent} \033[94m{ip} \033[38;5;1mSpoofing-attack\033[0m")
            sock.close()
        except OSError:
            pass
